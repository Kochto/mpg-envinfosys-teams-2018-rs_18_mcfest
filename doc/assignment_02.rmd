...
#### Setup Skript und Bilder werden eingeladen und anschließend die Projektionen auf Gleicheit überprüft. Das in QGis geschnittene Shapefile wird eingeladen und nach Überprüfung der Projektion werden die Rasterdateien auf die Bounding Box des Shapefiles zugeschnitten. Die weißen Streifen werden durch Zusammenfügen der betroffenen Bilder entfernt. Das finale Mosaik wird zusammengefügt und geplottet. 

#### setup Skript einladen noch nicht über einheitlichen Pfad möglich, da die Speicherkapazität der Uni PC's das nicht zulässt.
...
#### Überprüfen der Projektion des Shapefiles
...
#### Plotten (plotRGB(img)) Failed !! Überarbeiten
