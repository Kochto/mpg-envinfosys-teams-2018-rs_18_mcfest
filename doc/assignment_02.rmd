...
#### Setup Skript und Bilder werden eingeladen und anschließend die Projektionen auf Gleicheit überprüft. Das in QGis geschnittene Shapefile wird eingeladen und nach Ueerpruefung der Projektion werden die Rasterdateien auf die Bounding Box des Shapefiles zugeschnitten. Die weißen Streifen werden durch Zusammenfuegen der betroffenen Bilder entfernt. Das finale Mosaik wird zusammengefuegt und geplottet. 
...
#### Plotten 
```{r}
img <- plotRGB(brick(paste0(envrmt$path_data_aerial_processed, "img.tif")))
```
